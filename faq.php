...
<!-- Mirrored from ambed-html.vercel.app/main-html/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 01 Jun 2023 20:33:51 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title> FAQ || Ambed || Ambed HTML 5 Template </title>
    <!-- favicons Icons -->
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="faq-page__left">
                            <div class="accrodion-grp" data-grp-name="faq-one-accrodion">
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>Duis id leo id quam venenatis lobortis eu mattis ex.</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>Integer molestie dui vitae urna molestie, vel hendrerit lectus ultricies.
                                        </h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                ...
                                <div class="accrodion">
                                    <div class="accrodion-title">
                                        <h4>Maecenas venenatis lectus vel felis gravida, ut suscipit mi ultrices.</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                ...
                                <div class="accrodion last-chiled">
                                    <div class="accrodion-title">
                                        <h4>Cras laoreet arcu et risus consectetur, eu porttitor odio.</h4>
                                    </div>
                                    <div class="accrodion-content">
                                        <div class="inner">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="faq-page__right">
                            <div class="service-details__need-help">
                                ...
                                <h2 class="service-details__need-help-title">Easy Solutions <br> to Your Wall <br>
                                    Beauty</h2>
                            ...
                            <div class="faq-page__btn-box">
                                <a href="contact.html" class="thm-btn faq-page__btn">Book an Appointment</a>
                            </div>
                        </div>
                    </div>
                </div>
